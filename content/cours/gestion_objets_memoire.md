...
On peut rassembler ces deux étapes en une seule ligne. Cependant, il est
...
Les types simples du langage (`int`, `double`, etc) sont des types
...
![image](images/passage_entier.jpg)
